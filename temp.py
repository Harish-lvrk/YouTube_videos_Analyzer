...
def create_vector_store(_docs, api_key):
    ...
    try:
        # Using the standard embedding model name for compatibility.
            ...
            if user_question:
                with st.spinner("Finding answer..."):
                    try:
                        ...
                        qa_prompt_template = """Use the following pieces of context from the video transcript to answer the user's question.
